      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto">
              ...
              <div key={index} className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group">
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                    <Button className="bg-white text-gray-800 hover:bg-gray-100 rounded-full p-3">
          ...
          <div className="flex justify-center mt-12 space-x-4">
            <Button className="bg-primary-600 hover:bg-primary-700 text-white rounded-full p-3">
              <ChevronLeft size={20} />
            </Button>
            <Button className="bg-primary-600 hover:bg-primary-700 text-white rounded-full p-3">
